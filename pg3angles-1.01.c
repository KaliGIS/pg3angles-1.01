...
PGMODULEEXPORT Datum TIN_Area3D(PG_FUNCTION_ARGS)
{
...
PGMODULEEXPORT Datum TIN_Centroid(PG_FUNCTION_ARGS)
{
...
PGMODULEEXPORT Datum TIN_PartialDerivativesOfTriangle(PG_FUNCTION_ARGS)
{
  Datum vstup, medzivystup;
  ArrayType *vysledok;
  Oid element_type;
...
PGMODULEEXPORT Datum TIN_LinearZ(PG_FUNCTION_ARGS)
{
...
PGMODULEEXPORT Datum TIN_Flip (PG_FUNCTION_ARGS)
{
  /*
...
PGMODULEEXPORT Datum TIN_QuasiQuadraticZ(PG_FUNCTION_ARGS)
{
...
PGMODULEEXPORT Datum TIN_SlopeOfTriangle(PG_FUNCTION_ARGS)
{
  float8 zx, zy, sklon;
  Datum vstup;
...
PGMODULEEXPORT Datum TIN_AspectOfTriangle(PG_FUNCTION_ARGS)
{
...
PGMODULEEXPORT Datum TIN_PartialDerivativesOnVertex(PG_FUNCTION_ARGS)
{
...
PGMODULEEXPORT Datum TIN_SlopeOnVertex(PG_FUNCTION_ARGS)
{
  ArrayType *susedia;
  Oid trojeltype;
  int16 trojtyplen;
...
PGMODULEEXPORT Datum TIN_AspectOnVertex(PG_FUNCTION_ARGS)
{
  ArrayType *susedia;
  Oid trojeltype;
  int16 trojtyplen;
...
PGMODULEEXPORT Datum TIN_QuasiQuadraticDerivatives(PG_FUNCTION_ARGS)
{
...
PGMODULEEXPORT Datum TIN_NormalsAngle(PG_FUNCTION_ARGS)
{
...
PGMODULEEXPORT Datum TIN_IsConvexHull(PG_FUNCTION_ARGS)
{
  ArrayType *vystup;
  Oid o_eltype;
  int16 o_typlen;
...
PGMODULEEXPORT Datum TIN_Contours(PG_FUNCTION_ARGS)
{
  ArrayType *vysledok;
  Oid o_eltype;
  int16 o_typlen;
...
PGMODULEEXPORT Datum TIN_PartialDerivativesOnVertexAnglesWeight(PG_FUNCTION_ARGS)
{
  ArrayType *susedia, *vysledok;
  Oid trojeltype, o_eltype;
  int16 trojtyplen, o_typlen;
...
PGMODULEEXPORT Datum TIN_Cubature(PG_FUNCTION_ARGS)
{
